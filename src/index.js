...
// prototype
console.log(wordOne.capitalize()); // Hello world
...
const wordTwo = 'orange';
console.log(wordTwo.allUpperCase()); // ORANGE
...
const wordThree = 'the sky is blue';
console.log(wordThree.capitalizeWords()); // The Sky Is Blue

// ************************************************************************************************
// #4 - removeExtraSpaces()
// Removes all spaces from beg and end of a String along w  extra spaces in the middle.
...
const wordFour = '   hello     world   ';
console.log(wordFour.removeExtraSpaces()); // hello world
...
const wordFive = '    Hello World!!!!  a-hypenated-word  1, 2, 3, 5 and 77   ';
console.log(wordFive.kebobCase()); // hello-world-a-hypenated-word-1-2-3-5-and-77

// ************************************************************************************************
// #6 - snakeCase()
// Removes extra space & replaces spaces with an underscore "_", & makes all characters lowercase.
// ************************************************************************************************
...
const wordSix = '    Hello World!!!!  a-hypenated-word  1, 2, 3, 5 and 77   ';
console.log(wordSix.snakeCase()); // hello_world_ahypenatedword_1_2_3_5_and_77
...
const wordSeven = 'Hello there how are you';
console.log(wordSeven.camelCase()); // helloThereHowAreYou
...
const wordEight = 'hey hi';
console.log(wordEight.shift()); // ey hih
...
const wordNine = 'Amazing bongo drums for sale';
console.log(wordNine.makeHashTag()); // [ '#amazing', '#bongo', '#drums', '#for', '#sale' ]
...
const wordTen = 'Abd def';
const wordTenTwo = ' ';
console.log(wordTen.isEmpty()); // false
console.log(wordTenTwo.isEmpty()); // true
